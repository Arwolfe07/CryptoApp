...
import { useGetCryptoDetailsQuery, useGetCryptoHistoryQuery } from '../apis/cryptoAPI';
...
function CryptoDetails() {
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <Select defaultValue="7d" className="select-timeperiod" placeholder="Select Timeperiod" onChange={(value) => setTimePeriod(value)} value={timePeriod}>
        {time.map((date) => <Option key={date}>{date}</Option>)}
      </Select>
      <p className='warning'>**Not working Currently</p>
